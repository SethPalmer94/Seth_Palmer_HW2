...
int main(int argc, char* argv[])
{
	...
	case 1:
		...
		break;
	case 2:
		cout << "the two houses are equally expansive" << endl;
		break;
	case 3:
	...
	system("pause"); //keep window open in visual studio
	return 0;
}
...
struct house InputHouse(void)
{
	...
	cin >> placeHolder.streetNum;
	cout << "\nplease enter the street name" << endl;
	cin >> placeHolder.streetName;
	cout << "\n please enter the price" << endl;
	cin >> placeHolder.price;
